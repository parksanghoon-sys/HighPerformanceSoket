...
- 입력 directory: `docs\benchmarks\baselines\runners\local-win-x64-01\2026-06-29\session-02`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 229.5 | 789.2 | 856.7 | 1 | 0 | 0 |
| open-loop | 3 | 273.8 | 855.6 | 878.3 | 2 | 0 | 0 |
