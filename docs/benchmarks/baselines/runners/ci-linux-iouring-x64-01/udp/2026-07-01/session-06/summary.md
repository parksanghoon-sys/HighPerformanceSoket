...
- 입력 directory: `docs\benchmarks\baselines\runners\ci-linux-iouring-x64-01\udp\2026-07-01\session-06`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 494 | 1436.8 | 1656.7 | 0 | 0 | 0 |
| open-loop | 3 | 162.7 | 1273 | 1288.9 | 0 | 0 | 0 |

## Warnings

| code | kind | metric | value | threshold | source |
| --- | --- | --- | ---: | ---: | --- |
| load-p99-latency-high | load | p99-latency-us | 1436.8 | 1386.2 | `load-01.json` |
| load-p99-latency-high | load | p99-latency-us | 1656.7 | 1386.2 | `load-03.json` |
