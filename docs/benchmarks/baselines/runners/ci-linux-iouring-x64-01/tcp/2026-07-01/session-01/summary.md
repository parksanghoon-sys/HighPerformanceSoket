...
| --- | --- | --- | ---: | ---: | --- |
| load-p99-latency-high | load | p99-latency-us | 4144.5 | 1386.2 | `load-01.json` |
| load-p99-latency-high | load | p99-latency-us | 4134.4 | 1386.2 | `load-02.json` |
| load-p99-latency-high | load | p99-latency-us | 4298.8 | 1386.2 | `load-03.json` |
| open-loop-p99-latency-high | open-loop | p99-latency-us | 5588.6 | 1508.3 | `open-loop-01.json` |
| open-loop-p99-latency-high | open-loop | p99-latency-us | 4564 | 1508.3 | `open-loop-02.json` |
| open-loop-p99-latency-high | open-loop | p99-latency-us | 4541.5 | 1508.3 | `open-loop-03.json` |
