...
- 입력 directory: `docs\benchmarks\baselines\runners\ci-linux-iouring-x64-01\udp\2026-07-02\session-02`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 793.2 | 1774.6 | 1953.5 | 0 | 0 | 0 |
| open-loop | 3 | 1233 | 1287 | 1300.8 | 0 | 0 | 0 |

## Warnings

| code | kind | metric | value | threshold | source |
| --- | --- | --- | ---: | ---: | --- |
| load-p99-latency-high | load | p99-latency-us | 1953.5 | 1386.2 | `load-01.json` |
| load-p99-latency-high | load | p99-latency-us | 1504.2 | 1386.2 | `load-02.json` |
| load-p99-latency-high | load | p99-latency-us | 1774.6 | 1386.2 | `load-03.json` |
