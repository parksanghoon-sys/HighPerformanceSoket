...
- 입력 directory: `docs\benchmarks\baselines\runners\local-win-x64-01\2026-06-29\session-03`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 248.1 | 757.8 | 884.6 | 1 | 0 | 0 |
| open-loop | 3 | 273.3 | 825.2 | 978.9 | 2 | 0 | 0 |
