...
- D151 기준으로 Linux `io_uring` benchmark workflow 는 TCP/UDP protocol root 를 분리하므로,
  ...
  D154 이후 `ci-linux-iouring-x64-01` repository reference 가 존재하므로, 후속 workflow envelope step 은
  protocol별 reference history 와 실제 candidate summary 를 비교한다.
...
| --- | --- | --- | --- | --- | --- |
| ci-linux-iouring-x64-01/tcp | ci | tcp-loopback-iouring-v1 | IoUringTransport | [2026-07-02](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/history.json) | Linux io_uring TCP provisional reference, runner/protocol root [history.json](runners/ci-linux-iouring-x64-01/tcp/history.json) |
| ci-linux-iouring-x64-01/udp | ci | udp-loopback-iouring-v1 | IoUringTransport | [2026-07-02](runners/ci-linux-iouring-x64-01/udp/2026-07-02/history.json) | Linux io_uring UDP provisional reference, runner/protocol root [history.json](runners/ci-linux-iouring-x64-01/udp/history.json) |
...
| --- | --- | --- | --- | ---: | --- | ---: | --- |
| ci-linux-iouring-x64-01/tcp | 2026-07-02 | [history.json](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/history.json) | [history.md](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/history.md) | 3 | true | 18 | true |
| ci-linux-iouring-x64-01/udp | 2026-07-02 | [history.json](runners/ci-linux-iouring-x64-01/udp/2026-07-02/history.json) | [history.md](runners/ci-linux-iouring-x64-01/udp/2026-07-02/history.md) | 3 | true | 6 | true |
...
| 2026-07-02 | session-02 | ci-linux-iouring-x64-01 Linux TCP loopback io_uring, provisional reference adopted from run 28568500822 | [summary.json](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/session-02/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/session-02/summary.md) | 6 | true | 6 | 4559.9 | 4501.5 | 1 |
| 2026-07-02 | session-02 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28568500822 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-02/session-02/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-02/session-02/summary.md) | 6 | true | 3 | 1953.5 | 1300.8 | 0 |
| 2026-07-02 | session-03 | ci-linux-iouring-x64-01 Linux TCP loopback io_uring, provisional reference adopted from run 28569649366 | [summary.json](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/session-03/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/tcp/2026-07-02/session-03/summary.md) | 6 | true | 6 | 5061.1 | 4589.9 | 1 |
| 2026-07-02 | session-03 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28569649366 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-02/session-03/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-02/session-03/summary.md) | 6 | true | 2 | 1509.6 | 1317.5 | 0 |
...
| 2026-07-01 | session-02 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28493590950 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-02/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-02/summary.md) | 6 | true | 2 | 2033.4 | 1312.4 | 0 |
| 2026-07-01 | session-03 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28494135787 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-03/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-03/summary.md) | 6 | true | 3 | 1871.2 | 1270.3 | 0 |
| 2026-07-01 | session-04 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28494404015 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-04/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-04/summary.md) | 6 | true | 0 | 1246.9 | 1271.3 | 0 |
| 2026-07-01 | session-05 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28495804466 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-05/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-05/summary.md) | 6 | true | 2 | 1896.2 | 1282.4 | 0 |
| 2026-07-01 | session-06 | ci-linux-iouring-x64-01 Linux UDP loopback io_uring, provisional reference adopted from run 28497147332 | [summary.json](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-06/summary.json) | [summary.md](runners/ci-linux-iouring-x64-01/udp/2026-07-01/session-06/summary.md) | 6 | true | 2 | 1656.7 | 1288.9 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| TCP load | 6 | 18 | 3265.7 | 5061.1 | 4974.3 | 1.24 | 99.7 | 1 | 0 | 0 | 0 |
| TCP open-loop | 6 | 18 | 3471.4 | 5588.6 | 4621.8 | 1.31 | 100 | 1 | 0 | 0 | 0 |
| UDP load | 9 | 27 | 1124.7 | 2033.4 | 1774.6 | 1.46 | 99.9 | 0 | 0 | 0 | 0 |
| UDP open-loop | 9 | 27 | 1252.2 | 1414.6 | 1394.5 | 1.03 | 100 | 0 | 0 | 0 | 0 |
...
D158 기준으로 D155~D157 UDP candidate raw report 를 `session-02..04` provisional reference 로 수동 채택했다.
UDP protocol root history 는 session-count 4, hard-passed true, warning-count 8,
comparison-compatible true 상태다. updated reference history 로 `session-04` summary 를 envelope smoke 비교한 결과
`envelope-compatible=true`, `envelope-signal-count=0`을 확인했다.
따라서 반복된 open-loop `p50-median-us` signal 은 1-session provisional reference 의 얇은 p50 envelope 문제로 해석하고,
fixed registration, zero-copy send, latency hard gate, warning-as-failure 는 계속 열지 않는다.

D163 기준으로 D160/D162 passing artifact 의 raw report 도 protocol별 provisional reference 에 수동 채택했다.
TCP protocol root 는 `session-01..03`, UDP protocol root 는 `session-01..06`을 포함한다.
protocol root history 는 TCP session-count 3/warning-count 18, UDP session-count 6/warning-count 12이며,
...
사용자 push 이후 run `28568500822`로 D167 두 date root reference 의 원격 artifact gate 를 확인했다.
artifact `iouring-benchmark-artifacts-2026-07-02-github-28568500822-1` 기준 TCP/UDP baseline, summary, history,
envelope exit code 는 모두 0이다. TCP envelope 는 reference-summary-count 4, signal-count 0이고,
UDP envelope 는 reference-summary-count 7, signal-count 0이다.

D169 기준으로 run `28568500822` raw report 를 `2026-07-02/session-02` reference 로 수동 채택했다.
TCP protocol root 는 session-count 5, warning-count 30이고 UDP protocol root 는 session-count 8, warning-count 16이다.
둘 다 hard-passed true, comparison-compatible true 상태이며 최신 session 기준 envelope smoke 도
`envelope-compatible=true`, `envelope-signal-count=0`이다.

사용자 push 이후 run `28569649366`로 D170 reference 확장의 원격 artifact gate 를 확인했다.
artifact `iouring-benchmark-artifacts-2026-07-02-github-28569649366-1` 기준 TCP/UDP baseline, summary, history,
envelope exit code 는 모두 0이다. TCP envelope 는 reference-summary-count 5, signal-count 0이고,
UDP envelope 는 reference-summary-count 8, signal-count 0이다.

D172 기준으로 run `28569649366` raw report 를 `2026-07-02/session-03` reference 로 수동 채택했다.
TCP protocol root 는 session-count 6, warning-count 36이고 UDP protocol root 는 session-count 9, warning-count 18이다.
둘 다 hard-passed true, comparison-compatible true 상태이며 최신 session 기준 envelope smoke 도
`envelope-compatible=true`, `envelope-signal-count=0`이다.
