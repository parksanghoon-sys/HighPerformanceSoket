...
- 입력 directory: `docs/benchmarks/baselines/runners/ci-windows-x64-01/2026-06-25/session-01`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 146.6 | 262.5 | 275.3 | 1 | 0 | 0 |
| open-loop | 3 | 152.8 | 263.3 | 322.9 | 2 | 0 | 0 |
