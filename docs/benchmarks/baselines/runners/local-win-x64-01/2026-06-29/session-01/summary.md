...
- 입력 directory: `docs\benchmarks\baselines\runners\local-win-x64-01\2026-06-29\session-01`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 224.7 | 805.8 | 844.6 | 1 | 0 | 0 |
| open-loop | 3 | 257.1 | 897.2 | 948.8 | 2 | 0 | 0 |
