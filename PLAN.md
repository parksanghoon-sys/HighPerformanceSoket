...
- [~] **현재 검증 확장**: D243 mixed command/runner/workflow와 Windows SAEA/RIO 수락 완료. pushed-SHA Linux run에서 확인한 TCP 종료 정지와 mixed data 지연을 D244로 로컬 보강했으며, D244 push 후 io_uring contract/mixed gate 재실행 대기.
