...
- [~] **현재 검증 확장**: D243 mixed command/runner/workflow와 Windows SAEA/RIO 수락 완료. 첫 pushed-SHA Linux run의 solution restore 회귀를 로컬에서 교정했고 교정 commit push와 io_uring mixed gate 재실행 대기.
