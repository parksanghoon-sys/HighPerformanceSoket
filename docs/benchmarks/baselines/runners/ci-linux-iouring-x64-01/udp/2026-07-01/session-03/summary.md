...
- 입력 directory: `docs\benchmarks\baselines\runners\ci-linux-iouring-x64-01\udp\2026-07-01\session-03`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load | 3 | 802.1 | 1766.9 | 1871.2 | 0 | 0 | 0 |
| open-loop | 3 | 1228.9 | 1269.5 | 1270.3 | 0 | 0 | 0 |

## Warnings

| code | kind | metric | value | threshold | source |
| --- | --- | --- | ---: | ---: | --- |
| load-p99-latency-high | load | p99-latency-us | 1505.8 | 1386.2 | `load-01.json` |
| load-p99-latency-high | load | p99-latency-us | 1766.9 | 1386.2 | `load-02.json` |
| load-p99-latency-high | load | p99-latency-us | 1871.2 | 1386.2 | `load-03.json` |
